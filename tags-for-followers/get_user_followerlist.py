...
token = None
token_count = 0
token_names = ['UserDetails','UserDetails1','UserDetails2','UserDetails3','UserDetails4','UserDetails5','UserDetails6','UserDetails7','UserDetails8','UserDetails9','UserDetails10']
...
def save_user(user_id, directory):
	...
	next_url = 'https://api.instagram.com/v1/users/'+str(user_id)+'/followed-by?access_token='+token
	count = 0
	while True:
		try:	
			time.sleep(0.1)
...
if __name__ == '__main__':
	...
	users_map_file = 'data/mappings/user_mapping/users_map.json'
